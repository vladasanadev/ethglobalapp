...
export async function getFarcasterManifest() {
  ...
  return {
    ...
    miniapp: {
      ...
      subtitle: "womansplain, app", // 30 characters, no emojis or special characters, short description under app name
      description: "womansplain, app", // 170 characters, no emojis or special characters, promotional message displayed on Mini App Page
      ...
      ogDescription: "womansplain, app", // 100 characters, summarize core benefits in 1-2 lines
      screenshotUrls: [
